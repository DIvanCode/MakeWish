...
namespace MakeWish.UserService.UnitTests.UseCases.Features.Users.GetCurrent;

public class GetCurrentHandlerTests
{
    private readonly Mock<IUserContext> _userContextMock;
    private readonly IUnitOfWork _unitOfWork;
    private readonly GetCurrentHandler _sut;

    public GetCurrentHandlerTests()
    {
        _userContextMock = new Mock<IUserContext>();
        _unitOfWork = new UnitOfWorkStub();
        _sut = new GetCurrentHandler(_unitOfWork, _userContextMock.Object);
    }
