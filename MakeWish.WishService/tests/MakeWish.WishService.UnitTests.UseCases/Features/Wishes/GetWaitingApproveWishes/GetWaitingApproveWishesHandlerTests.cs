...
namespace MakeWish.WishService.UnitTests.UseCases.Features.Wishes.GetWaitingApproveWishes;
...
public class GetWaitingApproveWishesHandlerTests
{
    ...
    public async Task Handle_ShouldReturnWaitingApproveWishes_WhenUserIsAuthenticated()
    {
        ...
        result.Value.Should().AllSatisfy(wish => wish.Status.Should().Be(WishStatus.Completed));
    }
