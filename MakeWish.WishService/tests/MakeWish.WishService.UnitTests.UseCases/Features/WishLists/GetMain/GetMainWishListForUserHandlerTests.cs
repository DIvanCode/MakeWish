...
namespace MakeWish.WishService.UnitTests.UseCases.Features.WishLists.GetMain;

public class GetMainWishListForUserHandlerTests
{
    private readonly Mock<IUserContext> _userContextMock;
    private readonly IUnitOfWork _unitOfWork;
    private readonly GetMainWishListForUserHandler _handler;

    public GetMainWishListForUserHandlerTests()
    {
        _userContextMock = new Mock<IUserContext>();
        _unitOfWork = new UnitOfWorkStub();
        _handler = new GetMainWishListForUserHandler(_userContextMock.Object, _unitOfWork);
    }
    ...
    public async Task Handle_ShouldReturnWishList_WhenUserIsOwner()
    {
        ...
        var command = new GetMainWishListForUserCommand(owner.Id);
    ...
    public async Task Handle_ShouldReturnError_WhenUserIsNotAuthenticated()
    {
        ...
        var command = new GetMainWishListForUserCommand(Guid.NewGuid());
